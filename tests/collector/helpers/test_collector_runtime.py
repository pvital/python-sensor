...
class TestRuntimeHelper:
    ...
    @patch("instana.collector.helpers.resource_usage.get_resource_usage")
    def test_runtime_helper_initialization_with_resource_usage(self, mock_get_resource_usage):
        ...
        mock_get_resource_usage.return_value = mock_resource
        
        # Create helper
        helper = RuntimeHelper(collector=HostCollector(HostAgent()))
        
        # Verify resource usage was captured
    ...
    @patch("instana.collector.helpers.resource_usage.get_resource_usage")
    def test_collect_runtime_metrics_with_resource_usage(self, mock_get_resource_usage):
        ...
        mock_get_resource_usage.return_value = new_resource
